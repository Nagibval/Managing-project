 ...
 */
final class Version20250128170844 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, begin_date DATE NOT NULL, end_date DATE NOT NULL, estimate_end_date DATE NOT NULL, is_finished TINYINT(1) NOT NULL, priority INT DEFAULT NULL, cost DOUBLE PRECISION NOT NULL, is_success TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
